...
import StatusBadge from "packages/isomorphic-core/src/components/get-status-badge";
                ...
                {item?.dropdownItems ? (
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "before:top-2/5 bg-gray-100 text-primary before:absolute before:-start-3 before:block before:h-4/5 before:w-1 before:rounded-ee-md before:rounded-se-md before:bg-primary 2xl:before:-start-5"
