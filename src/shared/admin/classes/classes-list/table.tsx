...
import { getClassesColumns } from "@/shared/admin/classes/classes-list/columns";
const FilterElement = dynamic(
  () => import("@/shared/admin/classes/classes-list/filter-element"),
  { ssr: false }
);
...
export default function ClassesTable({ data = [] }: { data: any[] }) {
        ...
        tableFooter={
          ...
          >
            <Button size="sm" className="dark:bg-gray-300 dark:text-gray-800">
              ...
              {selectedRowKeys.length > 1 ? "Classes" : "Class"}{" "}
            </Button>
          </TableFooter>
        }
