...
import { CustomTooltip } from "packages/isomorphic-core/src/components/charts/custom-tooltip";
import { CustomYAxisTick } from "packages/isomorphic-core/src/components/charts/custom-yaxis-tick";
import {
  Bar,
  XAxis,
  YAxis,
...
import { useMedia } from "packages/isomorphic-core/src/hooks/use-media";
import SimpleBar from "packages/isomorphic-core/src/ui/simplebar";
import DropdownAction from "packages/isomorphic-core/src/components/charts/dropdown-action";
import cn from "packages/isomorphic-core/src/utils/class-names";
import { formatNumber } from "packages/isomorphic-core/src/utils/format-number";
import {
