...
import { getStudentColumns } from "@/shared/admin/student-assessment/attended-student-list/columns";
...
const FilterElement = dynamic(
  () =>
    import(
      "@/shared/admin/student-assessment/attended-student-list/filter-element"
    ),
  { ssr: false }
);
...
export default function AssessmentStudentTable({
  data = [],
}: {
  data: Student[];
}) {
